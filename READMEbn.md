...
| কমান্ড | বর্ণনা |
| ------- | ----------- |
| `git revert <commit-hash>` | একটি প্রতিশ্রুতি প্রত্যাবর্তন |
| `git reset --hard <commit-hash>` | একটি নির্দিষ্ট প্রতিশ্রুতিতে রিসেট করুন |

### Stashing পরিবর্তন

| কমান্ড | বর্ণনা |
| ------- | ----------- |
| `git stash` | একটি নোংরা কাজের ডিরেক্টরিতে লুকিয়ে রাখা পরিবর্তন |
| `git stash pop` | পপ স্ট্যাশ |
| `git stash clear` | সব লুকিয়ে রাখা এন্ট্রি সরান |

### অতিরিক্ত কমান্ড

| কমান্ড | বর্ণনা |
| ------- | ----------- |
| `git reset HEAD [file-name.txt]` | পর্যায় থেকে পরিবর্তনগুলি সরান |
| `git rebase -i <commit-hash>` | স্কোয়াশ কমিট (ইন্টারেক্টিভ রিবেস) |
| `git rebase <branch-name>` | একটি শাখা পুনর্বাসন |
| `git reset --hard <commit-hash>` | হার্ড রিসেট |
| `git fetch upstream` | আপস্ট্রিম পরিবর্তন আনুন |
| `git merge upstream/main` | আপস্ট্রিম পরিবর্তনগুলি মার্জ করুন |
| `git push origin main` | মূলে পরিবর্তনগুলি পুশ করুন |

### একত্রীকরণ দ্বন্দ্ব সমাধান করা

| কমান্ড | বর্ণনা |
| ------- | ----------- |
| `git merge <branch-name>` | একটি শাখা একত্রিত করুন (দ্বন্দ্ব সৃষ্টি করতে) |
| `git add [file-name.txt]` | পর্যায় সমাধান ফাইল |
| `git commit` | সমাধান করা পরিবর্তনের প্রতিশ্রুতি দিন |
