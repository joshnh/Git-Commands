...
### प्रतिबद्धताओं का प्रबंधन

| कमान्ड | विवरण |
| ------- | ----------- |
| `git revert <commit-hash>` | एक प्रतिबद्धता वापस करें |
| `git reset --hard <commit-hash>` | किसी विशिष्ट प्रतिबद्धता पर रीसेट करें |

### परिवर्तन छिपाना

| कमान्ड | विवरण |
| ------- | ----------- |
| `git stash` | गंदे कार्यशील निर्देशिका में परिवर्तनों को छिपाएँ |
| `git stash pop` | पॉप स्टैश |
| `git stash clear` | सभी संग्रहीत प्रविष्टियाँ हटाएँ |

### अतिरिक्त आदेश

| कमान्ड | विवरण |
| ------- | ----------- |
| `git reset HEAD [file-name.txt]` | मंच से परिवर्तन हटाएँ |
| `git rebase -i <commit-hash>` | स्क्वैश प्रतिबद्ध (इंटरैक्टिव रिबेस) |
| `git rebase <branch-name>` | एक शाखा को पुनः आधार बनाएं |
| `git reset --hard <commit-hash>` | मुश्किल रीसेट |
| `git fetch upstream` | अपस्ट्रीम परिवर्तन प्राप्त करें |
| `git merge upstream/main` | अपस्ट्रीम परिवर्तन मर्ज करें |
| `git push origin main` | परिवर्तनों को मूल स्थान पर पुश करें |

### मर्ज विवादों का समाधान

| कमान्ड | विवरण |
| ------- | ----------- |
| `git merge <branch-name>` | एक शाखा का विलय करना (संघर्ष उत्पन्न करना) |
| `git add [file-name.txt]` | स्टेज हल की गई फ़ाइलें |
| `git commit` | समाधानित परिवर्तन प्रतिबद्ध करें |
